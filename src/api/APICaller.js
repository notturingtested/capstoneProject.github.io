...
export default class APICaller {
    ...
    async getRequest(token, company, user, dateRange, dimension, limit) {
    ...
    async getToAllRequest(token, company, user, dateRange, dimension, fromPage, list) {
        const res = await fetch("https://appservice5.omniture.com/analytics/1.0/reports?allowRemoteLoad=default&useCache=true&includeOberonXml=false&includePlatformPredictiveObjects=false",
            {
                "headers": {
                    "accept": "application/json",
    ...
    async getSequenceRequest(token, company, user, dateRange, dimension) {
        const res = await fetch("https://appservice5.omniture.com/analytics/1.0/reports?allowRemoteLoad=default&useCache=true&includeOberonXml=false&includePlatformPredictiveObjects=false", {
            "headers": {
                "accept": "application/json",
                "accept-language": "en-US,en;q=0.9,zh-TW;q=0.8,zh-CN;q=0.7,zh;q=0.6",
...
// trying to test
    async getSeqRequest(token, company, user, dateRange, dimension, fromPage, toPage) {
        const res = await fetch("https://appservice5.omniture.com/analytics/1.0/reports?allowRemoteLoad=default&useCache=true&includeOberonXml=false&includePlatformPredictiveObjects=false",
            {
                "headers": {
                    "accept": "application/json",
